        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              <li>
                <Link to="/" className="text-sm text-gray-600 hover:text-[#c6ac8f] transition-colors duration-200 flex items-center gap-2 group">
                  <span className="w-1 h-1 rounded-full bg-gray-400 group-hover:bg-[#c6ac8f] transition-colors"></span>
                  Home
                </Link>
              </li>
              <li>
                <Link to="/features" className="text-sm text-gray-600 hover:text-[#c6ac8f] transition-colors duration-200 flex items-center gap-2 group">
                  <span className="w-1 h-1 rounded-full bg-gray-400 group-hover:bg-[#c6ac8f] transition-colors"></span>
                  Features
                </Link>
              </li>
              <li>
                <Link to="/about" className="text-sm text-gray-600 hover:text-[#c6ac8f] transition-colors duration-200 flex items-center gap-2 group">
                  <span className="w-1 h-1 rounded-full bg-gray-400 group-hover:bg-[#c6ac8f] transition-colors"></span>
                  About Us
                </Link>
              </li>
              <li>
                <Link to="/contact" className="text-sm text-gray-600 hover:text-[#c6ac8f] transition-colors duration-200 flex items-center gap-2 group">
                  <span className="w-1 h-1 rounded-full bg-gray-400 group-hover:bg-[#c6ac8f] transition-colors"></span>
                  Contact
                </Link>
              </li>
