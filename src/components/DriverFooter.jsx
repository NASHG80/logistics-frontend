        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              ...
              <li>
                <Link to="/driver/dashboard" className="text-sm text-gray-600 hover:text-[#c6ac8f] transition-colors duration-200 flex items-center gap-2 group">
                  <span className="w-1 h-1 rounded-full bg-gray-400 group-hover:bg-[#c6ac8f] transition-colors"></span>
                  Dashboard
                </Link>
              </li>
              <li>
                <Link to="/driver/pod-upload" className="text-sm text-gray-600 hover:text-[#c6ac8f] transition-colors duration-200 flex items-center gap-2 group">
                  <span className="w-1 h-1 rounded-full bg-gray-400 group-hover:bg-[#c6ac8f] transition-colors"></span>
                  Pod upload
                </Link>
              </li>
              <li>
                <Link to="/driver/profile" className="text-sm text-gray-600 hover:text-[#c6ac8f] transition-colors duration-200 flex items-center gap-2 group">
                  <span className="w-1 h-1 rounded-full bg-gray-400 group-hover:bg-[#c6ac8f] transition-colors"></span>
                  Profile
                </Link>
              </li>
